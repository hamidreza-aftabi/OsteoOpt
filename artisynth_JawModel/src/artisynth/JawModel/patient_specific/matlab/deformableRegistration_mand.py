...
source_path = str(geometry_dir / "mandible_with_cartilage.obj")
target_path = str(geometry_dir / "Rigid_Registered_Mandible_Solid_Smooth_Remeshed_With_Cartilage.obj")
out_path = str(geometry_dir / "Deformable_Registered_Mandible_Solid_Smooth_Remeshed_With_Cartilage.obj")
params_file = str(current_dir / "deformation_weights_mandible.json")
